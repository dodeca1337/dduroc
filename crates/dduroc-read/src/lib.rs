...
//! - **дамп** ([`Reader::open`]) — замороженный снимок: корень и схемы
//!   называются руками, потому что расшифровать записи без схемы нельзя —
//!   на диске лежат только идентификаторы и бинарные поля.
//!
//! # Время
//!
